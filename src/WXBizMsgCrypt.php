<?php
namespace Paulversion\WeworkCallback;

use Paulversion\WeworkCallback\Lib\ErrorCode;
use Paulversion\WeworkCallback\Lib\Prpcrypt;
use Paulversion\WeworkCallback\Lib\SHA1;
use Paulversion\WeworkCallback\Lib\XMLParse;
	...
	*/
    public function VerifyURL($sMsgSignature, $sTimeStamp, $sNonce, $sEchoStr, &$sReplyEchoStr)
    {
        if (strlen($this->m_sEncodingAesKey) != 43) {
            return \Paulversion\WeworkCallback\Lib\ErrorCode::$IllegalAesKey;
        }
